...
public class gasStation {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Enter the size of gas station: ");
        int n = sc.nextInt();
        System.out.println("Enter the gas units: ");
        ...
        System.out.printf("Starting point to complete the circuit is %d\t", startPoint);
    }
}
